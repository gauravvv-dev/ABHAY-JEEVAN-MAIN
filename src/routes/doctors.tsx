...
export const Route = createFileRoute("/doctors")({
  head: () => ({
    meta: [
      { title: "Doctors & Team — Vardan Hospital & Maternity Centre, Prayagraj" },
      { name: "description", content: "Meet the doctors, nurses and support staff at Vardan Hospital & Maternity Centre, Jhusi, Prayagraj." },
      { property: "og:title", content: "Doctors & Team — Vardan Hospital & Maternity Centre" },
...
const leads = [
  { img: doc1, missingFile: "src/assets/doctor1.jpg",imgPosition: "object-top", name: "Dr. Lal Ratnakar Singh", spec: "General Medicine", exp: "Senior Consultant", qual: "MBBS, MD", opdTimings: ["Mon - Sat: 10:00 AM - 2:00 PM", "Evening: 5:00 PM - 8:00 PM"], bio: "Senior physician at Vardan Hospital & Maternity Centre with deep expertise in internal medicine, chronic disease management, diabetes care and preventive medicine." },
  { img: doc2, missingFile: "src/assets/doctor2.jpg",imgPosition: "object-top", name: "Dr. Anjali Singh", spec: "Gynecology & Obstetrics", exp: "Senior Consultant", qual: "MBBS, MS, DNB, FMAS, GIMP", opdTimings: ["Mon - Sat: 9:30 AM - 1:30 PM", "Evening: 4:30 PM - 7:30 PM"], bio: "Specialist in high-risk pregnancies and minimally invasive gynecological surgery, with a calm, reassuring bedside manner and a strong focus on women's preventive health." },
  { img: doc3, missingFile: "src/assets/doctor3.jpg",imgPosition: "object-center", name: "Dr. Ramesh Gupta", spec: "Gynecology & Obstetrics", exp: "Senior Consultant", qual: "MBBS, MS, DNB, FMAS, GIMP", opdTimings: ["Mon - Sat: 9:30 AM - 1:30 PM", "Evening: 4:30 PM - 7:30 PM"], bio: "Specialist in high-risk pregnancies and minimally invasive gynecological surgery, with a calm, reassuring bedside manner and a strong focus on women's preventive health." },
];
console.log("doc3 value:", doc3);
          ...
          <div className="grid md:grid-cols-2 gap-8 mt-10">
            {leads.map((d, i) => (
              <motion.div key={d.name} initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }}
                ...
                <div className="aspect-[3/2] overflow-hidden bg-brand-soft">
                  <DoctorPhoto src={d.img} alt={d.name} missingFile={d.missingFile} className={`w-full h-full object-cover ${d.imgPosition}`} />
                </div>
                <div className="p-5">
                  ...
                  {d.opdTimings && (
                    <div className="mt-3 p-3 bg-brand-soft/50 border border-brand-soft rounded-xl">
        ...
        <div className="container-page">
          <div className="max-w-2xl">
            ...
            <p className="mt-4 text-muted-foreground">
              Behind every successful outcome at Vardan Hospital & Maternity Centre is a coordinated team of nurses, lab technicians, pharmacists, paramedics and patient-care coordinators — many of whom have been with us since the very beginning.
            </p>
          </div>
